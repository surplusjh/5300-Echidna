...
// Get a block from the databse file.
//
...
// Write a block back to the databse file.
//
...
// Wrapper for Berkeley DB, open and creation both are carried out here.
//
...
// Build the rows back from the bits written to the file.
//
